...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--image_dir',
      type=str,
      default='/Programming/Python/NeuralNetwork ImageRec/train/',
      help='Path to folders of labeled images.'
  )
  parser.add_argument(
      '--output_graph',
      type=str,
      default='/Programming/Python/NeuralNetwork ImageRec/tmp/output_graph.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--output_labels',
      type=str,
      default='/Programming/Python/NeuralNetwork ImageRec/tmp/output_labels.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='/Programming/Python/NeuralNetwork ImageRec/tmp/retrain_logs',
  ...
  parser.add_argument(
      '--model_dir',
      type=str,
      default='/Programming/Python/NeuralNetwork ImageRec/tmp/imagenet',
      help="""\
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='/Programming/Python/NeuralNetwork ImageRec/tmp/bottleneck',
